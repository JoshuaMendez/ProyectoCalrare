 ...
 * Fecha última modificación: 9 de Noviembre
 * Versión: 1.0
 *
...
DisperseMatrix::DisperseMatrix()//inicializa una matriz dispersa vacia con tamaño 0 x 0
{
    valores;
    filas;
    columnas;
...
list<int> DisperseMatrix::getRowLis(int fila)//Retorna una lista de enteros con los valores de la fila solicitada
{
    list<int> result;
    int i;
...
// siendo n = el tamaño del vector
// Complejidad O(n)
vector<pair<int, int>> DisperseMatrix::getRowVec(int fila)//Retorna un vector de pares de enteros con los valores de la fila y la columna correspondiente
{
...
// siendo n = el tamaño del vector
// Complejidad O(n)
list<int> DisperseMatrix::getColLis(int columna)//Retorna una lista de pares de enteros con los valores de columna y la fila correspondiente
{
    list<int> result;
    int i;
    for (i = 0; i < valores.size(); i++) // agrega en la posicion respectiva el valor diferente a 0
...
// siendo n = el tamaño del vector
// Complejidad O(n)
vector<pair<int, int>> DisperseMatrix::getColVec(int columna)//Retorna un vector de pares de enteros con los valores de columna y la fila correspondiente
{
    vector<pair<int, int>> result;
    pair<int, int> par;
    int i;
...
// siendo n = el tamaño del vector
// Complejidad O(n)
vector<pair<int, int>> DisperseMatrix::getDisperseRowVec(int fila)//Retorna un vector de pares de enteros con los valores de la fila y la columna correspondiente con sus 0
{
    vector<pair<int, int>> result;
    pair<int, int> par;
...
// Complejidad O(n)
list<int> DisperseMatrix::getDisperseRowLis(int fila)//Retorna una lista de pares de enteros con los valores de la fila y la columna correspondiente con sus 0
{
...
// siendo n = el valor maximo entre nColumnas y el tamaño del vector de valores
// Complejidad O(n)
list<int> DisperseMatrix::getDisperseColLis(int columna)//Retorna una lista de pares de enteros con los valores de columna y la fila correspondiente con sus 0
{
