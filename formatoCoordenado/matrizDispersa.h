...
public:
    ...
    list<int> getRowLis(int);                              // Retornar fila 
    vector<pair<int,int>> getRowVec(int);                            // Retornar fila 
    list<int> getColLis(int);                           // Retornar columna 
    vector<pair<int,int>> getColVec(int);                         //  Retornar columna 
    list<int> getDisperseRowLis(int);                      // Retornar fila con ceros 
    vector<pair<int,int>> getDisperseRowVec(int);                    // Retornar una fila con ceros 
    list<int> getDisperseColLis(int);                   // Retornar columna con ceros 
